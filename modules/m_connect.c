...
mo_connect(struct Client *source_p, int parc, char *parv[])
{
  ...
  {
    sendto_one_numeric(source_p, ERR_NEEDMOREPARAMS, "CONNECT");
    return 0;
  }
  ...
  if (parc > 3)
  {
    ...
    {
      sendto_one_numeric(source_p, ERR_NOPRIVS, "connect:remote");
      return 0;
    }
  ...
  {
    sendto_one_numeric(source_p, ERR_NOPRIVS, "connect");
    return 0;
  }
