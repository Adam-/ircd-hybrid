...
mo_hash(struct Client *source_p, int parc, char *parv[])
{
  ...
  sendto_one_notice(source_p, "Client: entries: %u buckets: %u "
  ...
  sendto_one_notice(source_p, "Channel: entries: %u buckets: %u "
                    "max chain: %u", count, buckets, max_chain);
  ...
  sendto_one_notice(source_p, "Id: entries: %u buckets: %u "
                    "max chain: %u", count, buckets, max_chain);
  ...
  sendto_one_notice(source_p, "UserHost: entries: %u buckets: %u "
                    "max chain: %u", count, buckets, max_chain);
  return 0;
}
